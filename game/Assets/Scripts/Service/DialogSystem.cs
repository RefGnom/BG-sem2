...
namespace Assets.Scripts.Service
{
    internal static class DialogSystem
    {
        public static Message GetMessage()
        {
            ...
            message = message.Next;
            var fork = GetFirstFork();
            message.Next = fork.Start;
            message = fork.End;

            message.Next = new Message("Вы немного солите суп духов. Внезапно в палатку заходит дух и замечает вас", FontStyles.Italic | FontStyles.Bold);
            message = message.Next;
            ...
            message = message.Next;
            message.Next = new Message("На обрыве весит дух, может мне помочь ему");
            message = message.Next;
        ...
        private static (Message Start, Message End) GetFirstFork()
        {
